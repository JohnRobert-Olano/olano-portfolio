...
function ProjectCard({ project, onClick }: { project: Project; onClick: () => void }) {
  const { ref, position } = useScrollReveal(0.15);
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="relative py-24 px-6 lg:px-24 bg-brand-dark border-t border-zinc-900 scroll-mt-24">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <motion.div 
          ...
          transition={{ duration: 0.6, ease: "easeOut" }}
          id="projects-header" 
          className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-8 w-full"
        >
          ...
          <div id="project-filters" className="flex flex-wrap gap-1 bg-zinc-950 border border-zinc-900 p-1.5 rounded-sm self-start">
            {["All", "Computer Vision", "AI Systems", "Full Stack"].map((tag) => (
              <button
                ...
                className={`text-[10px] uppercase font-mono tracking-wider px-4 py-2.5 rounded-sm transition-all duration-200 cursor-pointer ${
                  selectedTag === tag
            ...
            <div id="project-detail-overlay" className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
              ...
              >
                ...
                <button
                  id="btn-close-modal"
                  onClick={() => setActiveProject(null)}
                  className="absolute top-6 right-6 p-2.5 bg-zinc-900 hover:bg-brand-orange hover:text-black border border-zinc-850 rounded-sm text-zinc-400 transition-colors cursor-pointer"
                >
                  <X className="w-4 h-4" />
                </button>
                ...
                <div className="p-8 md:p-12 space-y-8">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                          ...
                          <button
                            ...
                            className="text-[10px] uppercase tracking-wider bg-brand-orange text-black font-black hover:bg-red-600 disabled:bg-zinc-800 disabled:text-zinc-650 transition px-6 py-3 cursor-pointer"
                          >
                  ...
                  <div className="flex flex-col sm:flex-row gap-6 pt-6 border-t border-zinc-900 justify-between items-start sm:items-center text-xs">
                    ...
                    <button
                      id="btn-close-bottom"
                      onClick={() => setActiveProject(null)}
                      className="text-zinc-400 hover:text-white font-mono uppercase tracking-widest bg-zinc-900 px-5 py-2.5 border border-zinc-850 hover:bg-brand-orange hover:text-black transition-colors text-[10px] cursor-pointer"
                    >
                      Close Space
                    </button>
                  </div>
