  ...
  education: [
    {
      ...
      duration: "2017 - 2021",
      details: [
        "Graduated with High Honors (GWA: 1.2)",
        "Senior Thesis: 'OptiTrace: Lightweight CNNs for Clinical Eye Disease Diagnosis on Mobile Devices'",
      ],
    },
  ],
  skills: [
