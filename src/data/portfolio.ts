...
export const portfolioData: PortfolioData = {
  personalInfo: {
    ...
    bio: "Associate Software Engineer & AI Builder bridging traditional full-stack architecture with next-generation agentic workflows and computer vision diagnostics.",
